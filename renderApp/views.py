...
def page_02(request, path_value):  # http://127.0.0.1:8000/renderApp/page_02/id/page/020
    ...
    print(request.path)
    context = {"path_value": path_value}
    return render(request, "renderApp/page_02.html", context, print())


def page_03(request, path_value):  # http://127.0.0.1:8000/renderApp/page_02/id/page/020
    print(path_value)
    print(request.path)
    context = {"path_value": path_value}
    return render(request, "renderApp/page_03.html", context)
